...
const CoffeeIcon = (props: React.SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      <defs>
        <clipPath id="_clipPath_N0o6drAtHsVxKLsH0tUgSvDkyO0eZq1y">
      ...
      <g clipPath="url(#_clipPath_N0o6drAtHsVxKLsH0tUgSvDkyO0eZq1y)">
        <g>
          ...
          />
          <path
            d=" M 44.049 49.011 Q 36.532 46.181 34.462 41.25 C 32.393 36.32 39.999 32.357 42.223 28.468 C 44.659 24.209 40.945 22.138 38.571 20.708 Q 36.197 19.277 36.288 19.338 Q 49.087 19.105 50.44 25.273 C 51.811 31.523 41.989 35.439 40.853 39.424 Q 40.034 42.3 44.049 49.011 Z "
            fill="rgb(232,151,0)"
          />
          <path
            d=" M 63.549 45.011 Q 56.032 42.181 53.962 37.25 C 51.893 32.32 59.499 28.357 61.723 24.468 C 64.159 20.209 60.445 18.138 58.071 16.708 Q 55.697 15.277 55.788 15.338 Q 68.587 15.105 69.94 21.273 C 71.311 27.523 61.489 31.439 60.353 35.424 Q 59.534 38.3 63.549 45.011 Z "
            fill="rgb(232,151,0)"
          />
          <path
            d=" M 83.049 52.011 Q 75.532 49.181 73.462 44.25 C 71.393 39.32 78.999 35.357 81.223 31.468 C 83.659 27.209 79.945 25.138 77.571 23.708 Q 75.197 22.277 75.288 22.338 Q 88.087 22.105 89.44 28.273 C 90.811 34.523 80.989 38.439 79.853 42.424 Q 79.034 45.3 83.049 52.011 Z "
            fill="rgb(232,151,0)"
          />
        </g>
      </g>
